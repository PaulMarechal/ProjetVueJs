...
.vue-form-builder .section-container:hover,
.vue-form-builder .section-container.active {
...
.vue-form-builder .normal-section,
.vue-form-renderer .normal-section {
    padding-top: 10px;
    padding-bottom: 10px;
}

.vue-form-builder .headline-block,
.vue-form-builder .vue-form-renderer {
    padding: 0 15px;
    user-select: none;
}
...
.vue-form-builder .add-row-outer,
.vue-form-builder .add-control-outer {
    margin-top: 15px;
    padding: 0 15px;
}

.vue-form-builder .add-row-container,
.vue-form-builder .add-control-container {
    margin-top: 40px;
    border: 3px rgba(0, 0, 0, .4) dotted;
    padding: 40px;
    user-select: none;
...
.vue-form-builder .add-row-container:hover,
.vue-form-builder .add-control-container:hover {
    border-color: #badc58;
    cursor: pointer;
    font-weight: bold;
}
...
.vue-form-builder .control-view-wrapper,
...
.vue-form-builder .toggleable-section,
.vue-form-renderer .toggleable-section {
    padding-top: 10px;
    padding-bottom: 10px;
}
...
.vue-form-builder .toggle-item,
.vue-form-renderer .toggle-item {
    cursor: pointer;
}

.vue-form-builder .radio-checkbox,
.vue-form-renderer .radio-checkbox {
    padding: 5px;
}
...
.vue-form-builder .radio-checkbox.next label,
.vue-form-renderer .radio-checkbox.next label {
...
/** CSS compatibility with vuematerial */
html.md-theme-default .container-fluid.md-layout.form-padding.vue-form-builder,
html.md-theme-default .container-fluid.md-layout.form-padding.vue-form-renderer {
    margin: auto;
    display: block !important;
}

html.md-theme-default .vue-form-builder .section-container {
    min-width: 100%;
    max-width: 100%;
}

.md-button.md-info,
.md-button.md-info.active,
.md-button.md-info.active:focus,
.md-button.md-info.active:hover,
.md-button.md-info:active,
.md-button.md-info:active:focus,
.md-button.md-info:active:hover,
.md-button.md-info:focus,
.md-button.md-info:hover,
.open>.md-button.md-info.dropdown-toggle,
.open>.md-button.md-info.dropdown-toggle:focus,
.open>.md-button.md-info.dropdown-toggle:hover {
    background-color: #00bcd4 !important;
    color: #fff !important;
}

.md-button.md-secondary,
.md-button.md-secondary.active,
.md-button.md-secondary.active:focus,
.md-button.md-secondary.active:hover,
.md-button.md-secondary:active,
.md-button.md-secondary:active:focus,
.md-button.md-secondary:active:hover,
...
.md-button.md-success.active,
.md-button.md-success.active:focus,
.md-button.md-success.active:hover,
.md-button.md-success:active,
.md-button.md-success:active:focus,
.md-button.md-success:active:hover,
.md-button.md-success:focus,
.md-button.md-success:hover,
.open>.md-button.md-success.dropdown-toggle,
.open>.md-button.md-success.dropdown-toggle:focus,
.open>.md-button.md-success.dropdown-toggle:hover {
    background-color: #4caf50 !important;
    color: #fff !important;
}

.md-button.md-warning,
.md-button.md-warning.active,
.md-button.md-warning.active:focus,
.md-button.md-warning.active:hover,
.md-button.md-warning:active,
.md-button.md-warning:active:focus,
.md-button.md-warning:active:hover,
.md-button.md-warning:focus,
.md-button.md-warning:hover,
.open>.md-button.md-warning.dropdown-toggle,
.open>.md-button.md-warning.dropdown-toggle:focus,
.open>.md-button.md-warning.dropdown-toggle:hover {
    background-color: #ff9800 !important;
    color: #fff !important;
}

html.md-theme-default .vue-form-builder .sidebar {
    z-index: 5;
    right: 0;
    left: auto;
...
html.md-theme-default .vue-form-builder .sidebar a.md-list-item-action {
    width: 100%;
    color: #495057 !important;
    text-align: inherit;
}

html.md-theme-default .vue-form-builder .sidebar .close {
    z-index: 6;
}

html.md-theme-default .vue-form-builder a.md-list-item-action {
    width: 100%;
    color: #495057 !important;
    text-align: inherit;
}

html.md-theme-default .vue-form-builder .md-list-item {
    position: relative;
    display: block;
